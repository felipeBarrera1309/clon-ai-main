# Menu Products Specification

## Purpose
Menu products are the items that restaurants offer to customers. Each product belongs to a category, has pricing information, and can optionally have an associated image URL for visual display.
