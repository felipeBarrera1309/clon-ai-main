...
## Purpose
The guided onboarding system enables non-technical restaurant owners to set up their AI-powered ordering system through a 5-step wizard. It automates menu import, location setup, delivery zone configuration, bot calibration, and business rules definition, reducing implementation time from days to hours.
