...
function SidebarProvider({
	...
	const { useAtomValue } = require("jotai/react")
	const {
		sidebarWrapperClassNameAtom,
	} = require("../../../../apps/web/modules/dashboard/atoms")

	const sidebarWrapperClassName = useAtomValue(sidebarWrapperClassNameAtom)
		...
		return (
			<Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
				<SheetContent
					...
					data-slot="sidebar"
					data-mobile="true"
					className="overflow-visible! w-(--sidebar-width) bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden"
					style={
						{
					...
					onPointerDownOutside={(e) => {
						// Prevenir que se cierre si se hace click en elementos de autenticación
						const target = e.target as HTMLElement
						if (target.closest("[data-auth-component]")) {
							e.preventDefault()
						}
					}}
				>
